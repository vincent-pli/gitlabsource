...
import (
	v1alpha1 "github.com/vincent-pli/gitlabsource/pkg/apis/sources/v1alpha1"
...
var gitlabsourcesResource = schema.GroupVersionResource{Group: "sources.eventing.knative.dev", Version: "v1alpha1", Resource: "gitlabsources"}

var gitlabsourcesKind = schema.GroupVersionKind{Group: "sources.eventing.knative.dev", Version: "v1alpha1", Kind: "GitLabSource"}
...
func (c *FakeGitLabSources) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.GitLabSource, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(gitlabsourcesResource, c.ns, name, data, subresources...), &v1alpha1.GitLabSource{})
