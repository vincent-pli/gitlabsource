...
import (
	...
	scheme "github.com/vincent-pli/gitlabsource/pkg/client/clientset/versioned/scheme"
...
// GitLabSourcesGetter has a method to return a GitLabSourceInterface.
// A group's client should implement this interface.
type GitLabSourcesGetter interface {
	GitLabSources(namespace string) GitLabSourceInterface
}
...
// gitLabSources implements GitLabSourceInterface
...
func (c *gitLabSources) List(opts v1.ListOptions) (result *v1alpha1.GitLabSourceList, err error) {
	result = &v1alpha1.GitLabSourceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("gitlabsources").
